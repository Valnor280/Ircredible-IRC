...
void		join_single(int socket_client, server &my_serv, std::string chan, std::string key)
{
	...
	else
	{
		...
		else if(find(my_serv.get_chan_map()[chan].get_ban_list(my_serv.get_usermap()).begin(), my_serv.get_chan_map()[chan].get_ban_list(my_serv.get_usermap()).end(), my_serv.get_usermap()[socket_client]) == my_serv.get_chan_map()[chan].get_ban_list(my_serv.get_usermap()).end() || my_serv.get_chan_map()[chan].get_ban_list(my_serv.get_usermap()).empty() == 1)
		{
