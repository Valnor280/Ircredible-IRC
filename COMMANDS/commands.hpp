...
void		LUSERS(std::string input, int socket_client, server & my_serv); // a voir
void		MODE(std::string input, int socket_client, server & my_serv);
void		MOTD(std::string input, int socket_client, server & my_serv);
void		NAMES(std::string input, int socket_client, server & my_serv); // l'option X est chelou
...
void		REHASH(std::string input, int socket_client, server & my_serv); // a voir
...
void		USERS(std::string input, int socket_client, server & my_serv); // a voir
void		VERSION(std::string input, int socket_client, server & my_serv); // a voir
...
void		KNOCK(std::string input, int socket_client, server & my_serv); // a voir
